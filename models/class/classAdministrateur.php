...
// méthodes CRUD class administrateur
        ...
        public function suppressionAdmin($nomAdministrateur,$prenomAdministrateur,$motPass,$idSelection)
        {
            $sql = $this->connexionBdd($hote,$user,$motPass,$db);
        ...
        public function editionAdmin($nomAdministrateur,$prenomAdministrateur,$motPass,$idSelection)
        {
            $sql = $this->connexionBdd($hote,$user,$motPass,$db);
            $sql ->prepare ("SELECT  nom_admin, prenomAdministrateur, password FROM Administrateur ) WHERE $idSelection=id_admin;");
            $sql ->execute();
        }
