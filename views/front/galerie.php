...
<?php include ('../public/assets/inc/header.php');?>
    ...
    <div class="hidden md:block container mx-auto px-4">
        ...
        <div class="carousel relative overflow-hidden mt-6">
            ...
            <div class="carousel-inner flex">
                ...
                <div class="slide">                 
                    <img src="../public/assets/img/1(3).webp" alt="represente une serviette">
                </div>
                <!-- Deuxième diapositive -->
                <div class="slide">                  
                    <img src="../public/assets/img/1(4).webp" alt="represente un t-shirt">
                </div>
                <!-- Troisième diapositive -->
                <div class="slide">                 
                    <img src="../public/assets/img/1(2).webp" alt="represente une horloge">
                </div>
                <!-- Quatrième diapositive -->
                <div class="slide">                 
                    <img src="../public/assets/img/1(5).webp" alt="poignée de baby-foot">
                </div>
                <!-- Cinquième diapositive -->
                <div class="slide">                    
                    <img src="../public/assets/img/1(6.1).webp" alt="represente une plaque route 66">
                </div>
                <!-- Sixième diapositive -->
                <div class="slide">                 
                    <img src="../public/assets/img/1(7).webp" alt="reprensente un lavabo en bois">
                </div>
                <!-- 7eme diapositive -->
                <div class="slide">                  
                    <img src="../public/assets/img/1(8).webp" alt="represente une plaque avec un dragon">
                </div>
                <!-- 8eme diapositive -->
                <div class="slide">                 
                    <img src="../public/assets/img/1(10).webp" alt="represente une horloge">
                </div>
                <!-- 9eme diapositive -->
                <div class="slide">                   
                    <img src="../public/assets/img/1(13).webp" alt="represente des objets imprimés en 3d">
                </div>
                <!-- 10eme diapositive -->
                <div class="slide">                   
                    <img src="../public/assets/img/1(14).webp" alt="represente des objets imprimés en 3d">
                </div>
                <!-- 11eme diapositive -->
                <div class="slide">
                    <!-- Image de la cinquième diapositive -->
                    <img src="../public/assets/img/1(15).webp" alt="represente un capteur de distance">
                </div>
                <!-- 12eme diapositive -->
                <div class="slide">                    
                    <img src="../public/assets/img/1(16).webp" alt="écusson brodé avec une voiture">
                </div>
                <!-- 13eme diapositive -->
                <div class="slide">                  
                    <img src="../public/assets/img/1(17).webp" alt="écusson brodé avec une voiture">                      
                </div>
                <!-- 14eme diapositive -->
                <div class="slide">                 
                    <img src="../public/assets/img/1(18).webp" alt="écusson brodé avec une voiture">
                </div>
            </div>
...
<?php include ('../public/assets/inc/footer.php');?>

<script src="../public/assets/js/testCarousel.js" async></script>
</body>
