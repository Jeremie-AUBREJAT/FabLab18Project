...
<?php include ('../public/assets/inc/head.php');?>

<body>
<?php include ('../public/assets/inc/header.php');?> <!-- Rappel du header -->
...
<div class="flex">
    ...
    <div class="divOriginal grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        <div class="m-5 lg:m-10 p-2 lg:p-10 text-3xl rounded-3xl bg-gray-300 shadow-xl">
        ...
        <div class="p-10">
        <img class="rounded-2xl" src="../public/assets/img/entreFabLab.webp" alt="Image représentant l'entrée du FabLab.">
        </div>
    </div>
    ...
    <div id="div_1" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10"> 
        ...
        <div class="p-10">
                <img class="border-2 border-gray-600 rounded-2xl" src="../public/assets/img/1(6).webp" alt ="Image qui représentee une imrpimante 3D et 2d mais pas un téléphone, le lapsus est souvent fait! Nous n'avons aucune affiliations avec Takotek">
        </div>   
    </div>
    ...
    <div id="div_2" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        ...
        <div class= " p-10">
            <img class="rounded-2xl" src="../public/assets/img/1(8.1).webp" alt="Toujour pas un téléphone mais une image représentant un écran pour montage vidéo">
        </div>
    </div>
    ...
    <div id="div_3" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        <div class="m-5 lg:m-10 p-10 text-3xl rounded-3xl bg-gray-300 shadow-xl">
        ...
        <div class="p-10">
            <img class="rounded-2xl" src="../public/assets/img/design3D.webp" alt="Image représentant le design 3D et 2D.">
        </div>
    </div>
    ...
    <div id="div_4" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        ...
        <div class="p-10">
            <img class="rounded-2xl" src="../public/assets/img/arduino.webp" alt="Image représentant un arduino">
        </div>
    </div>
    ...
    <div id="div_5" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        ...
        <div class="p-10">
            <img class ="rounded-2xl" src="../public/assets/img/image1.webp" alt="Image en 3D représentant une fraiseuse">
        </div>
    </div>
    ...
    <div id="div_6" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 lg:p-10">
        ...
        <div class="p-10">
            <img class="border-2 border-gray-600 rounded-2xl" src="../public/assets/img/brodeuse.webp" alt="Image représentant une brodeuse.">
        </div>
    </div>
</div>
...
<?php include ('../public/assets/inc/footer.php');?> <!--Rappel du footer -->
