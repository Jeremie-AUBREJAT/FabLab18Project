...
<body>
    <div class="formation flex">
        <select name="session" class="bg-gray-300 text-black rounded-md shadow-lg p-3 m-5 text-xl">
...
<div class="grid">
<div class="divOriginal grid-cols-12 p-5 m-5 ">
    <p class="col-span-4 text-3xl">Choisissez une formation</p>
    <p>    <img class="col-span-8"  src="img/entreFabLab.jpg" alt="Image représentant l'entrée du FabLab."></p>

</div>
        <div id="div_1" class="allDiv p-5 m-5 text-3xl">
            <p class="justify-between">Envie de créer sa propre figurine ou réparer un objet cassé ? L’imprimante 3D pour vous servir. Venez apprendre les bases de la manipulation 3D en utilisant vos filaments PLA pour un choix total de la couleur !</p>
        ...
        <div id="div_3" class="allDiv p-5 m-5 text-3xl">
        ...
        <div id="div_4" class="allDiv p-5 m-5 text-3xl">
        ...
        <div id="div_5" class="allDiv p-5 m-5 text-3xl">
        ...
        <div id="div_6" class="allDiv p-5 m-5 text-3xl">
