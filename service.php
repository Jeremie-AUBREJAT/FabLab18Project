...
<div class="grid">
    ...
    <div id="div_1" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 p-10"> 
        ...
        <div class="p-10">
                <img class="rounded-2xl" src="img/image3.png" alt ="Image qui représentee une imrpimante 3D et 2d mais pas un téléphone, le lapsus est souvent fait! Nous n'avons aucune affiliations avec Takotek">
        </div>   
    </div>
    ...
    <div id="div_3" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 p-10">
        ...
        <div class="p-10">
            <img class="rounded-2xl" src="img/design3D.png" alt="Image représentant le design 3D et 2D.">
        </div>
    </div>
    ...
    <div id="div_4" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 p-10">
        ...
        <div class="p-10">
            <img class="rounded-2xl" src="img/arduino.jpg" alt="Image représentant un arduino">
        </div>
    </div>
    ...
    <div id="div_6" class="allDiv grid grid-cols-2 max-lg:grid-cols-1 p-10">
        ...
        <div class="p-10">
            <img class="rounded-2xl" src="img/brodeuse.png" alt="Image représentant une brodeuse.">
        </div>
    </div>
</div>
