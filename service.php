...
<div class="grid">
    <div class="divOriginal grid grid-cols-2 gap-4">
        ...
        <div class="p-10">
        <img src="img/entreFabLab.jpg" alt="Image représentant l'entrée du FabLab.">
        </div>
    </div>
    ...
    <div id="div_1" class="allDiv grid grid-cols-2 gap-4"> 
        <div class="p-10 text-3xl">
            ...
            <p class="text-center">Envie de créer sa propre figurine ou réparer un objet cassé ? L’imprimante 3D pour vous servir. Venez apprendre les bases de la manipulation 3D en utilisant vos filaments PLA pour un choix total de la couleur !</p>
        </div>
        <div class="p-10">
                <img src="img/image3.png" alt ="Image qui représentee une imrpimante 3D et 2d mais pas un téléphone, le lapsus est souvent fait! Nous n'avons aucune affiliations avec Takotek">
        </div>   
    </div>
    ...
    <div id="div_2" class="allDiv grid grid-cols-2 gap-4">
        <div class="p-10 text-3xl">
            <p class="p-8 text-5xl text-wrap text-center">La formation montage vidéo</p>
            <p class="text-center">Passionné(e) par le montage ? Venez apprendre à modifier vos propres vidéos avec le logiciel Pinnacle !
        ...
        <div class="p-10">
            <img src="img/image2.png" alt="Toujour pas un téléphone mais une image représentant un écran pour montage vidéo">
        </div>
    </div>
    ...
    <div id="div_3" class="allDiv grid grid-cols-2 gap-4">
        <div class="p-10 text-3xl">
            <p class="p-8 text-5xl text-wrap text-center">La formation maquette 3D et 2d</p>
            <p class="text-center">Apprenez à maquetter en 2D ou en 3D sur un logiciel dédié !</p>
        </div>
        <div class="p-10 text-3xl">
            <img src="img/design3D.png" alt="Image représentant le design 3D et 2D.">
        </div>
    </div>
    ...
    <div id="div_5" class="allDiv grid grid-cols-2 gap-4">
        <div class="p-10 text-3xl">
            <p class="p-8 text-5xl text-wrap text-center">La formation fraiseuse</p>
            <p class="text-center">Envie de tailler ou faire une découpe dans un matériaux comme le métal ou le bois pour créer un élément de décoration ?
        ...
        <div class="p-10 text-3xl">
            <img src="img/image1.png" alt="Image en 3D représentant une fraiseuse">
        </div>
    </div>
    ...
    <div id="div_6" class="allDiv grid grid-cols-2 gap-4">
        <div class="p-10 text-3xl">
            <p class="p-8 text-5xl text-wrap text-center">La formation brodeuse numérique</p>
            <p class="text-center">Envie de retrouver son logo ou dessin sur sweat, t-shirt, casquette ou une serviette ? Venez le dessiner et le broder sur le linge de votre choix !</p>
        </div>
        <div class="p-10 text-3xl">
            <img src="img/brodeuse.png" alt="Image représentant une brodeuse.">
        </div>
    </div>
</div>
