    ...
    <div class="container mx-auto flex flex-wrap justify-between items-center">
        ...
        <div class="invisible lg:visible lg:mr-24">
            <div class="text-center justify-center mb-6">          
                <a href="mentions-legales.php" class="border-solid border-2 border-gray-600 text-black text-xl font-semibold bg-gray-100 hover:text-white hover:bg-gray-600 transition-all duration-300 px-4 py-2 rounded-2xl shadow-xl transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">Mentions légales</a>

            </div>
  
            <div class="text-center justify-center"> 
                <a href="contact.php" class="border-solid border-2 border-gray-600 text-black text-xl font-semibold bg-gray-100 hover:text-white hover:bg-gray-600 transition-all duration-300 px-4 py-2 rounded-2xl shadow-xl transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none">Contact</a>
